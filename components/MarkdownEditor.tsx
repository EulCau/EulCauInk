...
export const MarkdownEditor: React.FC<MarkdownEditorProps> = ({ 
  ...
  // Handle anchor clicks in preview to scroll the container instead of the window
  const handlePreviewClick = (e: React.MouseEvent<HTMLDivElement>) => {
    ...
    if (anchor) {
      ...
      if (href && href.startsWith('#')) {
        ...
        // Special case: `rehype-slug` adds IDs to headers. 
        // We look for that ID within the document.
